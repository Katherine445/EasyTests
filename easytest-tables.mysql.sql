...
ALTER TABLE /*$wgDBprefix*/et_question_test
  DROP FOREIGN KEY /*$wgDBprefix*/et_question_test_ibfk_1;
ALTER TABLE /*$wgDBprefix*/et_ticket
  DROP FOREIGN KEY /*$wgDBprefix*/et_ticket_ibfk_1;

ALTER TABLE /*$wgDBprefix*/et_test
  ADD test_page_title VARCHAR(255) BINARY NOT NULL
  AFTER test_id;
SET @i = 1;
UPDATE /*$wgDBprefix*/et_test
SET test_page_title = test_id, test_id = (@i := @i + 1);
ALTER TABLE /*$wgDBprefix*/et_test
  CHANGE test_id test_id INT UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE /*$wgDBprefix*/et_test
  ADD UNIQUE KEY (test_page_title);

UPDATE /*$wgDBprefix*/et_question_test, /*$wgDBprefix*/et_test
SET qt_test_id = test_id
WHERE qt_test_id = test_page_title;
ALTER TABLE /*$wgDBprefix*/et_question_test
  CHANGE qt_test_id qt_test_id INT UNSIGNED NOT NULL;

UPDATE /*$wgDBprefix*/et_ticket, /*$wgDBprefix*/et_test
SET tk_test_id = test_id
WHERE tk_test_id = test_page_title;
ALTER TABLE /*$wgDBprefix*/et_ticket
  CHANGE tk_test_id tk_test_id INT UNSIGNED NOT NULL;
ALTER TABLE /*$wgDBprefix*/et_ticket
  ADD tk_details BLOB DEFAULT NULL
  AFTER tk_displayname;

ALTER TABLE /*$wgDBprefix*/et_question_test
  ADD CONSTRAINT /*$wgDBprefix*/et_question_test_ibfk_1 FOREIGN KEY (qt_test_id) REFERENCES /*$wgDBprefix*/et_test (test_id)
  ON DELETE CASCADE
  ON UPDATE CASCADE;
ALTER TABLE /*$wgDBprefix*/et_ticket
  ADD CONSTRAINT /*$wgDBprefix*/et_ticket_ibfk_1 FOREIGN KEY (tk_test_id) REFERENCES /*$wgDBprefix*/et_test (test_id)
  ON UPDATE CASCADE;
