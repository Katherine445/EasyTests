...
Then click "Select results" again.',
    ...
    'easytests-parse-form'          => 'Form[:\s]*',
    'easytests-parse-form-text'     => 'Text[:\s]*',
    'easytests-parse-form-name'     => 'Name[:\s]*',
    'easytests-parse-form-m-fields' => 'Mandatory\s*fields[:\s]*',
    'easytests-parse-form-m-field'  => 'Mandatory\s*field[:\s]*',
    'easytests-parse-form-fields'   => 'Fields[:\s]*',
    'easytests-parse-form-field'    => 'Field[:\s]*',
    'easytests-parse-form-m-checks' => 'Mandatory\s*checkboxes[,\s]*',
    'easytests-parse-form-m-check'  => 'Mandatory\s*checkbox[,\s]*',
    'easytests-parse-form-checks'   => 'Checkboxes[,\s]*',
    'easytests-parse-form-check'    => 'Checkbox[,\s]*',
...
Далі знову натисніть «Вибрати результати». ',
    ...
    'easytests-parse-form'          => '(?:Анкета|Form)[:\s]*',
    'easytests-parse-form-text'     => '(?:Текст|Text)[:\s]*',
    'easytests-parse-form-name'     => '(?:Ім’я|Name)[:\s]*',
    'easytests-parse-form-m-fields' => '(?:Обов’язкові\s*поля|Mandatory\s*fields)[:\s]*',
    'easytests-parse-form-m-field'  => '(?:Обов’язкове\s*поле|Mandatory\s*field)[:\s]*',
    'easytests-parse-form-fields'   => '(?:Поля|Fields)[:\s]*',
    'easytests-parse-form-field'    => '(?:Поле|Field)[:\s]*',
    'easytests-parse-form-m-checks' => '(?:Обов’язкові\s*чекбокси|Обов’язкові\s*прапорці|Mandatory\s*checkboxes)[,\s]*',
    'easytests-parse-form-m-check'  => '(?:Обов’язковий\s*чекбокс|Обов’язковий\s*прапорець|Mandatory\s*checkbox)[,\s]*',
    'easytests-parse-form-checks'   => '(?:Чекбокси|Прапорці|Checkboxes)[,\s]*',
    'easytests-parse-form-check'    => '(?:Чекбокс|Прапорець|Checkbox)[,\s]*',
